...
class myAdminPDO extends PDO{
	public function __construct(){
		try{
			parent::__construct( config::dbAdmin_dsn, config::dbAdmin_user, config::dbAdmin_pass, config::db_opt);
			$this->setAttribute( PDO::ATTR_STATEMENT_CLASS, array('myPDOStatement'));
		} catch (PDOException $e){
			die($e->getMessage());
		}
	}
